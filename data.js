var DATA = [
  { user: 'ingikim', message: 'Welcome to Code States #codestates', createdAt: '2019-01-03 12:30:20' },
  { user: 'satya', message: 'this is test message #pair #programming', createdAt: '2019-01-04 18:30:20' },
  { user: 'sundar', message: 'code now! #work #hard', createdAt: '2019-01-05 07:30:20' },
  { user: 'steve', message: 'Stay hungry, and stay foolish', createdAt: '2015-01-03 12:30:20' },
  { user: 'tim', message: 'education for real world', createdAt: '2019-01-04 18:30:20' }
];
...
function generateNewTweet()/*  */ {
  ...
  tweet.createdAt = new Date().format(); // 어떻게 하면 보기 좋은 형태로 나타낼 수 있을까요? -->new Date().format();
  return tweet;
}
...
v댓글 출력 함수
* 함수1(객체 => html)
* 함수2(){ 함수 1 이용해서 ul태그 안에 추가하는 과정}
* data 배열 foreach(함수 2)
v댓글 등록 함수
* 아이디,커멘트 받아오기
* 등록 버튼을 누르면 댓글 추가
*/